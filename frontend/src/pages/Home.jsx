    ...
    return (
        <div className='bg-black/[0.99] w-full h-screen pt-20'>
            <div className='flex flex-col  justify-center items-center mt-20'>
                ...
                <Link to={"/register"} className='p-3  w-[10%]  text-center rounded-[3px] cursor-pointer bg-black/50 border border-gray-100/15  text-white/55 hover:text-white/80 text-sm hover:border-white/15'>
                    Get started
                </Link>
            </div>
